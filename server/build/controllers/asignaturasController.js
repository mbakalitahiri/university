    ...
    index(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.default.then((r) => {
                let result = r.query("select asignatura.id, asignatura.nombre_curso, asignatura.id_profesor, profesor.nombre, profesor.apellidos from asignatura inner join profesor on asignatura.id_profesor = profesor.id", function (error, rows) {
                    res.send(rows);
                });
            });
        });
...
exports.default = exports.asignaturaController;
