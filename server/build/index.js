...
class Server {
    ...
    routes() {
        ...
        this.app.use("/api/v1/alumno/", alumnoRoutes_1.default);
        this.app.use("/api/v1/asignatura/", asignaturaRoutes_1.default);
        this.app.use("/api/v1/notas/", notasRoutes_1.default);
        this.app.use("/api/v1/login/", authRoutes_1.default);
        this.app.use("/api/v1/search/", searchRoutes_1.default);
    }
    start() {
